...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the reported Lorenz-96 AD-EnFF")
...
def main():
    ...
    model = AdaptiveENFF(args.dim, attention=args.attention).to(device)
